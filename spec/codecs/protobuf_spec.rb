...
describe LogStash::Codecs::Protobuf do
  ...
  #   let(:plugin_human) { LogStash::Codecs::Protobuf.new("class_name" => "Animal::Human", "include_path" => ['spec/helpers/human.pb3.rb'])  }
  #   before do
  ...
  #   let(:plugin_col) { LogStash::Codecs::Protobuf.new("class_name" => "ColourProtoTest", "include_path" => ['spec/helpers/ColourTestcase.pb3.rb'])  }
  #   before do
  #       plugin_col.register      
  #   end
  ...
  # context "#encode" do
  #   subject do
  #     next LogStash::Codecs::Protobuf.new("class_name" => "Animal::UnicornEvent", "include_path" => ['spec/helpers/unicorn_event.pb3.rb']) 
  #   end
  ...
  # context "#encode2" do
  #   subject do
  #     next LogStash::Codecs::Protobuf.new("class_name" => "Animal::Human", "include_path" => ['spec/helpers/human.pb3.rb']) 
  #   end
  ...
  # context "#encode3" do
  #   subject do
  #     next LogStash::Codecs::Protobuf.new("class_name" => "ColourProtoTest", "include_path" => ['spec/helpers/ColourTestcase.pb3.rb'])
  #   end

  #   require 'spec/helpers/ColourTestcase.pb3.rb' # otherwise we cant use the colour enums in the next line
